...
import os
# from langchain.embeddings import HuggingFaceEmbeddings # 구식
# from langchain_community.embeddings import HuggingFaceEmbeddings
# from langchain_huggingface import HuggingFaceEmbeddings
from langchain_community.embeddings import HuggingFaceEmbeddings
# from langchain.vectorstores import FAISS # 구식
from langchain_community.vectorstores import FAISS
# from langchain.document_loaders import PyPDFLoader # 구식
...
if user_input:
    ...
    prompt = ChatPromptTemplate.from_messages(
        [
            (
                """다음 질문에 대해 주어진 컨텍스트를 사용하여 답변해주세요:
질문: {question}
컨텍스트: {context}
답변:"""
