## https://github.com/teddylee777/langchain-mini/blob/main/02-Project/pages/03_Multi_Turn.py 참조
...
# 체인 생성
def create_chain(model_name="gemma2:2b"):
